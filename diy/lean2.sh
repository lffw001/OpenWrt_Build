...
cp -af feeds/xiangfeidexiaohuo/php8/* feeds/packages/lang/php8/
...
##加入作者信息
sed -i "s/DISTRIB_REVISION='*.*'/DISTRIB_REVISION='By longfeifengwu $(date +%Y%m%d)'/g" package/lean/default-settings/files/zzz-default-settings
